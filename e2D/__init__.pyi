...
class Vector2D:
    ...
    def lerp(self:"Vector2D", other:"int|float|Vector2D|list|tuple", t: float) -> "Vector2D":
        """
    ...
    def __call__(self:"Vector2D") -> tuple: ...

    # fast operations     Vector2D.operation(x,y,both)
    def set(self, x:int|float=.0, y:int|float=.0, both:int|float=.0) -> None: ...

    def add(self, x:int|float=.0, y:int|float=.0, both:int|float=.0) -> None: ...
    
    def sub(self, x:int|float=.0, y:int|float=.0, both:int|float=.0) -> None: ...
    
    def mult(self, x:int|float=.0, y:int|float=.0, both:int|float=.0) -> None: ...
    
    def pow(self, x:int|float=.0, y:int|float=.0, both:int|float=.0) -> None: ...
    
    def mod(self, x:int|float=.0, y:int|float=.0, both:int|float=.0) -> None: ...
    
    def div(self, x:int|float=.0, y:int|float=.0, both:int|float=.0) -> None: ...
    
    def fdiv(self, x:int|float=.0, y:int|float=.0, both:int|float=.0) -> None: ...
